...
def display_results_summary(constObj, usrObject, df):
    ...
    if not df.empty:
        st.caption('Satellite transit schedule for transits over 80 deg of peak elevation above the horizon (all times are in local timezone of the selected location).')
